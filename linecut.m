...
set(hand.mainfig,'WindowButtonDownFcn',@MouseClick,'KeyPressFcn',@KeyPress);
...
set(get(hand.ycutax,'Title'),'String',['y=' num2str(hand.Ydata(hand.yindex)) ' (index #' num2str(hand.yindex) ')']);
set(get(hand.xcutax,'Title'),'String',['x=' num2str(hand.Xdata(hand.xindex)) ' (index #' num2str(hand.xindex) ')']);
guidata(hand.mainplot, hand);
